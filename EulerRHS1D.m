function [rhsrho, rhsrhou, rhsEner] = EulerRHS1D(rho, rhou ,Ener, time, FinalTime)
...
rhoin    =1;   rhouin   = 0; Enerin   = 10^-12;
pin      = (gamma-1.0)*(Enerin - 0.5*(rhouin).^2./rhoin);   
rhoout   = 1;   rhouout  = 0;
Enerout  = 10^-12; pout     = (gamma-1.0)*(Enerout - 0.5*(rhouout).^2./rhoout);
